	...
	<body>
		<div id="wrapper">
			...
			<div id="page-wrapper" style="background: #f2f2f2;min-width: 800px;">
				<form action="../invoiceManageServlet?action=selectWorkOrderR" method="post">
					<div class="page-navigation">发票登记/ register page</div>
			...
			<!-- /#page-wrapper -->
<%
	Object message = request.getSession().getAttribute("messageSWR");
