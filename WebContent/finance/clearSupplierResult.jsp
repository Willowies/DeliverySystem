...
<html>
	<head>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/clearSupplierResult.js"></script>
			...
			<div id="page-wrapper" style="background: #f2f2f2;min-width: 800px;  min-height: 299px;">
				...
				<div style="display: flex;flex-direction: row;align-items:flex-start;">
					<div class="homeblock3" style="margin-left:auto; margin-right:auto;">
						...
						<form action="../clearMoneyServlet?action=selectOrder" method="post" role="form">
				...
				<form method="post">
					<div class="searchResult">
						...
						<c:forEach items="${resultList1}" var="porder">
							<div class="searchItem">
							<p class="p20"><input type="checkbox" value="In${porder.purchaseId}" name="chk"></p>
						...
						<c:forEach items="${resultList2}" var="corder">
							<div class="searchItem">
							<p class="p20"><input type="checkbox" value="Out${corder.returnOrderId}" name="chk"></p>
						...
						<button class="buttonjiesuan" type="submit" onclick="clearSupplier()">结算</button>
					</div>
				</form>
				</div>
			</div>
<%
	Object message = request.getSession().getAttribute("messageclearSupplier");
