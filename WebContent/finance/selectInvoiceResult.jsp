			...
			<div id="page-wrapper" style="background: #f2f2f2;min-width: 800px;  min-height: 299px;">
				...
				<div style="display: flex;flex-direction: column;align-items:flex-start;">
					<div class="homeblock3" style="margin-left:auto; margin-right:auto;">
						<form action="../invoiceManageServlet?action=select" method="post" role="form">
				...
				<form method="post">
					<div class="searchResult">
						...
						<div class="searchItem">
							<p class="p45">${invoice.invoiceId}</p>
							<p class="p45">${invoice.workId }</p>
							<p class="p40">${invoice.invoiceAmount }</p>
							<p class="p70">${invoice.registerDate}</p>
							<p class="p70">${invoice.receiveDate}</p>
							<p class="p90">${invoice.stateInfo}</p>
							</div>
					</div>
				</form>
				</div>
