	...
	<body>
		<div id="wrapper">
			...
			<div id="page-wrapper" style="background: #f2f2f2;min-width: 800px;">
				<form action="../invoiceManageServlet?action=select" method="post">
			...
			<!-- /#page-wrapper -->
<%
	Object message = request.getSession().getAttribute("messageSI");
...
<%
	request.getSession().setAttribute("messageSI", null);
	}
%>
		</div>
		<!-- /#wrapper -->
