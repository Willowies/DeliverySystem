...
<html>
	...
	<body>
			...
			<div id="page-wrapper" style="background: #f2f2f2;min-width: 800px;  min-height: 299px;">
				...
				<div style="display: flex;flex-direction: column;align-items:flex-start;">
					<div class="homeblock3" style="margin-left:auto; margin-right:auto;">
						<form action="../invoiceManageServlet?action=selectSubInvoice" method="post" role="form">
				...
				<form method="post">
					<div class="searchResult">
						...
						<div class="searchItem">
							<p class="p45">${subinvoice.invoiceId}</p>
							<p class="p45">${subinvoice.workId }</p>
							<p class="p40">${subinvoice.invoiceAmount }</p>
							<p class="p70">${subinvoice.registerDate}</p>
							<p class="p40">${subinvoice.stateInfo}</p>
						</div>
					</div>
				</form>
				<div class="homeblock3" style="margin-left:auto; margin-right:auto;">
						<form action="../invoiceManageServlet?action=getSubstationInvoice" method="post" role="form">
								...
								<p style="float:left; margin: 17px 20px 5px 80px;width= 20px;font-size: 15px;">领用分站</p>
								<div style="float:left;margin: 11px 20px 0 40px; width:254px;">
									<input type="text" name="substationName" class="form-control1" style="height: 34px;border-radius: 4px; line-height:18px;" placeholder="">
								</div>
		...
		<!-- Nav CSS -->
<%
	Object message = request.getSession().getAttribute("messageGSIR");
