	...
	<body>
		<div id="wrapper">
			...
			<div id="page-wrapper" style="background: #f2f2f2;min-width: 800px;">
				<form action="../invoiceManageServlet?action=selectSubInvoice" method="post">
					<div class="page-navigation">领用发票 / getInvoice page</div>
			...
			<!-- /#page-wrapper -->
<%
	Object message = request.getSession().getAttribute("messageGSI");
