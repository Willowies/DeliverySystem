	...
	<body>
		<div id="wrapper">
			...
			<div id="page-wrapper" style="background: #f2f2f2;min-width: 800px;">
				<form action="../clearMoneyServlet?action=selectSign" method="post">
					<div class="page-navigation">查询签收单 / search page</div>
					<div class="searchblock">
						<p1>查询签收单</p1>
						<p>分站</p>
						<input type="text" name="substation" id="createDate">
						<p>签收日期</p>
...
<%
	Object message = request.getSession().getAttribute("messageCSUB");
...
<%
	request.getSession().setAttribute("messageCSUB", null);
	}
%>
	</body>
