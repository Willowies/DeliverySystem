	...
	<body>
		<div id="wrapper">
			...
			<div id="page-wrapper" style="background: #f2f2f2;min-width: 800px;">
				<form action="<%=basePath%>/firstClassMangerServlet?action=selectproducts" method="post">
					<div class="page-navigation">查询分类下辖商品/Select Product</div>
					<div class="searchblock">
						<p1>搜索商品</p1>
						<p>分类名称</p>
						<input type="text" name="firstclassname" id="firstclassname">				
