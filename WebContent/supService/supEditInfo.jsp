		...
		<!-- 左侧导航栏 -->
					...
					<div class="sidebar-nav navbar-collapse">
						<ul class="nav" id="side-menu">
							...
							<li class="highlight-item">
								<a href="registerClient.jsp"><i class="fa fa-user nav_icon"></i>新增供应商
								</a>
								<!-- /.nav-second-level -->
							</li>
								<li>
			...
			<div id="page-wrapper" style="background: #f2f2f2;min-width: 800px;  min-height: 299px;">
				<div class="page-navigation">
					<strong>修改供应商信息 / Edit Supplier Information</strong>
				</div>
				<!-- 搜索 -->
				...
				<!--/# 搜索 -->
					...
					<div class="panel-body">
						<form role="form" class="form-horizontal" action="supManageServlet?action=updateSup"  method="post" >
						
						<input type="hidden" name="supId" value="${editSup.supId}">
							
							<div class="form-group">
								<label class="col-md-2 control-label" style = "width:100px ;">供应商名称</label>
								<div class="col-md-8">
									<div class="input-group">
									<input type="text" name="supName" value="${editSup.supName}"  class="form-control1" placeholder="必填"
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<div class="input-group">
									<input type="text" name="supAddress" value="${editSup.supAddress}"  class="form-control1" placeholder="必填"
									style = "width:450px;margin-left:0%">
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<div class="input-group">
										 <input type="text" name="supLinkman" value="${editSup.supLinkman}" class="form-control1" placeholder="必填"
										 style = "width:450px;margin-left:0%">
									</div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-8">
									...
									<input type="text" name="supPhone" value="${editSup.supPhone}" class="form-control1" placeholder="可选"
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<div class="input-group input-icon right">
									<input type="text" name="supBankName" value="${editSup.supBankName}" class="form-control1" placeholder="可选"
									style = "width:450px;margin-left:0%">
									</div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-8">
									<div class="input-group input-icon right">
										<input type="number" name="supBankAccount" value="${editSup.supBankAccount}" class="form-control1" placeholder="必填"
										style = "width:450px;margin-left:0%" maxlength="11">
									</div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-8">
									<div class="input-group input-icon right">
										<input type="number" name="supFax" value="${editSup.supFax}" class="form-control1" placeholder="必填"
										style = "width:450px;margin-left:0%" maxlength="11">
									</div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-8">
									<div class="input-group input-icon right">
										...
										<input type="number" name="supPostcode" value="${editSup.supPostcode}" class="form-control1" placeholder="可选"
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<div class="input-group input-icon right">
										<input type="text" name="supLegalPerson" value="${editSup.supLegalPerson}" class="form-control1"
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<div class="input-group input-icon right">
										<input type="text" name="supRemark" value="${editSup.supRemark}" class="form-control1"
											placeholder="可选" style = "width:450px;margin-left:0%">
									</div>
								</div>
							</div>
