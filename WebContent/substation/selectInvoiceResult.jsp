		...
		<div id="wrapper">
						...
						<ul class="nav" id="side-menu">
							...
							<li>
								...
								<ul class="nav nav-second-level collapse" aria-expanded="false" style="height:0px;">
									...
									<li  class="highlight-item"><a href="selectInvoice.jsp">发票查询</a></li>
								</ul>
								<!-- /.nav-second-level -->
							</li>
						</ul>
			...
			<div id="page-wrapper" style="background: #f2f2f2;min-width: 800px;  min-height: 299px;">
				<div class="page-navigation">
					<strong>查询发票 / search page</strong>
				</div>
				<!-- 搜索 -->
				<div style="display: flex;flex-direction: column;align-items:flex-start;">
					<div class="homeblock3" style="margin-left:auto; margin-right:auto;">
						<form action="../invoiceManageServlet?action=selectfromS" method="post" role="form">
				...
				<form method="post">
					<div class="searchResult">
						...
						<div class="searchItem">
							<p class="p45">${invoicefromS.invoiceId}</p>
							<p class="p45">${invoicefromS.workId }</p>
							<p class="p40">${invoicefromS.invoiceAmount }</p>
							<p class="p70">${invoicefromS.registerDate}</p>
							<p class="p70">${invoicefromS.receiveDate}</p>
							<p class="p90">${invoicefromS.stateInfo}</p>
							</div>
					</div>
				</form>
				</div>
