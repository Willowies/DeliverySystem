<%@page import="com.neuedu.model.po.Sign"%>
					...
					<div class="sidebar-nav navbar-collapse">
						<ul class="nav" id="side-menu">
							...
							<li class="highlight-item">
								...
								<%
									String judge = (String)session.getAttribute("searchbutton");
									if(judge == null || judge.equals("")){
										session.removeAttribute("resultList");
									}else{
										session.removeAttribute("searchbutton");
									}
								%>
								</a>
								<!-- /.nav-second-level -->
			...
			<div id="page-wrapper" style="background: #f2f2f2;min-width: 800px;  min-height: 299px;">
				...
				<div style="display: flex;flex-direction: row;align-items:flex-start;">
					<div class="homeblock3" style="margin-left:auto; margin-right:auto;">
						...
						<form action="substationServlet?action=print" method="post" role="form">
							<div class="form-group">
								<p style="margin: 15px 0 5px 15px;font-size: 15px; width:254px;">配送员代号</p>
								<div style="margin: 0 0 0 15px; width:254px;">
									<input type="text" class="form-control1" style="height: 34px;border-radius: 4px; line-height:18px;" name="deliveryStaffId">
								</div>
							</div>
							<div class="form-group">
				...
				<!--/# 搜索 -->
					...
					<div class="searchResult">
						...
						<% 
						List<WorkOrder> list = (ArrayList<WorkOrder>)session.getAttribute("resultList");
						Sign sign = (Sign)request.getAttribute("resultSign");
						if(list!=null){
						...
						<div class="searchItem">
							...
							<button class="workButton" onClick="printSign<%=i%>()">打印</button>
							...
							<div id="showDiv<%=i%>" style="display:none; position: fixed; top: 0; right: 0; bottom: 0; left: 0; z-index:1050; overflow-y: auto !important;">
								<div class="homeblock5" style="margin-left:auto; margin-right:auto;">
									<div style="padding:30px 45px 10px 45px;">
										<button type="button" class="close" onClick="closebutton<%=i%>()">×</button>
										<p class="title">签收单</p>
									</div>
									<div class="bodyStyle" style="padding-top:0;" id="insertSign<%=i%>">
										
									</div>
									<div class="signFooter">
										<button type="button" class="btn btn-default"  style="width: 86px;">确认打印</button>
									</div>
						...
						<div class="pageFoot" style="margin:8px 10px 5px 10px;">
							<ul class="pagination" style="margin:10px 0;">
						        ...
						        <c:forEach  begin="1" end="${pageCount}" var="p">
									...
									<c:if test="${p!=pageNum}">
										<li><a href="substationServlet?action=print&pageNum=${p}" >${p}</a></li>
									</c:if>
								</c:forEach>
