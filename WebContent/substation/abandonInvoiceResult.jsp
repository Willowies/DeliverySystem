						...
						<ul class="nav" id="side-menu">
							...
							<li>
								...
								<ul class="nav nav-second-level collapse" aria-expanded="false" style="height:0px;">
									<li><a href="getClientInvoice.jsp">发票领用</a></li>
									<li  class="highlight-item"><a href="abandonInvoice.jsp">发票作废</a></li>
			...
			<div id="page-wrapper" style="background: #f2f2f2;min-width: 800px;  min-height: 299px;">
				...
				<div style="display: flex;flex-direction: column;align-items:flex-start;">
					<div class="homeblock3" style="margin-left:auto; margin-right:auto;">
						<form action="../invoiceManageServlet?action=selectWorkOrderAfromS" method="post" role="form">
				...
				<!--/# 搜索 -->
					...
					<div class="searchResult">
						...
						<div class="searchItem">
							<p class="p70">${workorderAfromS.workId}</p>
							<p class="p70">${workorderAfromS.orderId}</p>
							<p class="p90">${neworderAfromS.productName}</p>
							<p class="p70">${neworderAfromS.productQuantity}</p>
							<p class="p70">${neworderAfromS.productUnit}</p>
							<p class="p40">${neworderAfromS.total}</p>
							<p class="p70">${workorderAfromS.createDate}</p>
						</div>
					</div>
					</div>
					<div style="margin:0 auto;">
