			...
			<div id="page-wrapper" style="background: #f2f2f2;min-width: 800px;  min-height: 299px;">
				...
				<div style="display: flex;flex-direction: row;align-items:flex-start;">
					<div class="homeblock3" style="margin-left:auto; margin-right:auto;">
						...
						<form action="substationServlet?action=record" method="post" role="form">
				...
				<!--/# 搜索 -->
					...
					%>
						<div class="searchItem">
							...
							<button class="workButton" onClick="assignWork<%=i%>()">录入</button>
							...
							<div id="showDiv<%=i%>" style="width:300px; margin:0 auto; display:none; position: absolute; top:20%; left:42%; z-index:1050; background:#fff; border-radius: 10px;">
								<div class="homeblock4" style="margin-left:auto; margin-right:auto;">
									...
									<form action="substationServlet?action=recordFeedback" method="post" role="form">
										<div class="form-group">
											<p style="margin: 15px 0 5px 15px;font-size: 15px; width:254px;">任务单号</p>
											<div style="margin: 0 0 0 15px; width:254px;">
												<input type="text" class="form-control1" style="height: 34px;border-radius: 4px; line-height:18px;"
												 name="workIdRecord" value="<%=workOrder.getWorkId()%>" readonly="readonly">
											</div>
										</div>
										<div class="form-group">
											<p style="margin: 15px 0 5px 15px;font-size: 15px; width:254px;">客户满意度</p>
											<div style="margin: 0 0 0 15px; width:254px;">
												<select class="selectpicker" style="width: 254px;" name="customerFeedback" id="site_id">
										...
										<div class="form-group">
											...
											<div style="margin: 0 0 0 15px; width:254px;">
												<input type="text" class="form-control1" style="height: 34px;border-radius: 4px; line-height:18px;"
												 name="remarkRecord" value="">
											</div>
										</div>
										<div class="buttonblock">
											<button type="submit">保存录入</button>
										</div>
									</form>
