	...
	<body>
		<div id="wrapper">
			...
			<div id="page-wrapper" style="background: #f2f2f2;min-width: 800px;">
				<form action="../invoiceManageServlet?action=selectWorkOrderAfromS" method="post">
					<div class="page-navigation">发票作废/ abandon page</div>
...
<%
	Object message = request.getSession().getAttribute("messageAIfromS");
