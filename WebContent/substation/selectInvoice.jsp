	...
	<body>
		<div id="wrapper">
			...
			<div id="page-wrapper" style="background: #f2f2f2;min-width: 800px;">
				<form action="../invoiceManageServlet?action=selectfromS" method="post">
					<div class="page-navigation">查询发票 / search page</div>
					<div class="searchblock1">
						<p1>查询发票</p1>
						<p>发票号</p>
						<input type="text" name="invoiceId" id="createDate">
			...
			<!-- /#page-wrapper -->
<%
	Object message = request.getSession().getAttribute("messageSIfromS");
