					...
					<div style="display: flex;flex-direction: column;">
						<div class="homeblock2">
							...
							<div class="buttonblock">
								<button type="submit" onclick="window.location.href='substation/searchWorkOrder.jsp'">前往</button>
							</div>
						</div>
						<div class="homeblock2">
							...
							<div class="buttonblock">
								<button type="submit" onclick="window.location.href='substation/workAssign.jsp'">前往</button>
							</div>
						</div>
						<div class="homeblock2">
							...
							<div class="buttonblock">
								<button type="submit" onclick="window.location.href='substation/signPrint.jsp'">前往</button>
							</div>
						</div>
					</div>
					<div style="display: flex;flex-direction: column;">
						<div class="homeblock2" style="margin-left:20px;">
							...
							<div class="buttonblock">
								<button type="submit" onclick="window.location.href='substation/feedbackRecord.jsp'">前往</button>
							</div>
						</div>
						<div class="homeblock2" style="margin-left:20px;">
							...
							<div class="buttonblock">
								<button type="submit" onclick="window.location.href='substation/paymentQuery.jsp'">前往</button>
							</div>
						</div>
						<div class="homeblock2" style="margin-left:20px;">
							<p style="margin: 15px;font-size: 18px;font-family: '微软雅黑';">发票查询</p>
							<p style="border-top: 2px solid #999; width: 254px;margin:0 0 8px 15px;height: 1px" />
							<p style="margin: 0 0 0 15px; width:254px;">管理发票</p>
							<div class="buttonblock">
								<button type="submit" onclick="window.location.href='substation/">前往</button>
							</div>
						</div>
					</div>
