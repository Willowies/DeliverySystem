	...
	<div id="wrapper">
		...
		<ul class="nav navbar-nav navbar-right">
			...
			<li class="dropdown"><a href=""
				onclick="window.location.href='exit'" class="dropdown-toggle avatar"
				data-toggle="dropdown"><img src="../images/exit.png" alt="" /></a>
			</li>
		</ul>
		<!--左侧导航栏-->
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					<li><a href="dispatchHome.jsp"><i
							class="fa fa-home fa-fw nav_icon"></i>主页</a></li>
					<li><a href="dispatchGoods.jsp"><i
							class="fa fa-exchange nav_icon"></i>订单管理</a> <!-- /.nav-second-level -->
					</li>
					<li class="highlight-item"><a href="modifyOrderStatus.jsp"><i
							class="fa fa-edit nav_icon"></i>生成订单</a> <!-- /.nav-second-level -->
					</li>
				</ul>
			</div>
			<!-- /.sidebar-collapse -->
