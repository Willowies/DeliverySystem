			...
			<div id="page-wrapper" style="background: #f2f2f2;min-width: 800px;">
				<div class="container-fluid">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class = "row">
							<div class="cancelblock3 col-md-12">
								<p>订单信息</p>
							...
							<form action="../Order/OrderServlet?action=creatCancelOrder" method="post" role="form">
								<div class="cancelblock4">
									<div class="form-group">
										...
										<p>备注</p>
										<div class="form-group">
											<textarea class="form-control" name="cancelReason" rows="5" transparent autofocus x-webkit-speech></textarea>
										</div>
										<div class="form-group">
											<label class="hidden"></label>
											<p>要求日期：</p>
											<input type="Date" name="requireCancelDate" value="" id="requireCancelDate">
										</div>
										<div class="form-group">
											<label class="hidden"></label>
