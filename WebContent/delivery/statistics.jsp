		...
		<div id="wrapper">
			...
			<div id="page-wrapper" style="background: #f2f2f2;min-width: 800px;">
				...
				<form action="../deliveryPartServlet?action=orderStatistics" method="post">
					<div class="searchblock" style="height: 400px;width: 300px;margin-left: 50px;">
						<p1>订购统计</p1>
						<p>开始日期</p>
				...
				<form action="../deliveryPartServlet?action=substationStatistics" method="post">
					...
					<div class="searchblock" style="height: 400px;width: 300px;margin-left: 50px;">
						<p1>分站配送统计</p1>
						<p>开始日期</p>
						<input  type="date" name="start2" id="ipt3" style="width: 200px;" required="required" onblur="date2()">
						<p>结束日期</p>
						<input  type="date" name="end2" id="ipt4" style="width: 200px;" required="required" onblur="dateEnd2()">
						<div class="buttonblock">
							<button type="submit" style="margin-top: 20px;" onclick="checkform()">搜索</button>
						</div>
					</div>
				</form>
				<form action="../deliveryPartServlet?action=satisfyStatistics" method="post">
					
					<div class="searchblock" style="height: 400px;width: 300px;margin-left: 50px;">
						<p1>满意度统计</p1>
						<p>开始日期</p>
						<input  type="date" name="start3" id="ipt5" style="width: 200px;" required="required" onblur="date3()">
						<p>结束日期</p>
						<input  type="date" name="end3" id="ipt6" style="width: 200px;" required="required" onblur="dateEnd3()">
						<div class="buttonblock">
							<button type="submit" style="margin-top: 20px;" onclick="checkform()">搜索</button>
						</div>
					</div>
