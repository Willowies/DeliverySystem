	...
	<body>
		<div id="wrapper">
			...
			<div id="page-wrapper" style="background: #f2f2f2;min-width: 800px;">
				<div class="page-navigation">商品二级分类管理</div>
				<div style="display: flex;flex-direction: row;">
					...
					<div style="display: flex;flex-direction: column;">
						<div class="homeblock2">
							<p style="margin: 15px;font-size: 20px;font-family: '微软雅黑';">添加商品二级分类</p>
							<p style="border-top: 2px solid #999; width: 220px;margin:10px 0 8px 15px;height: 1px" />
							<p style="margin: 0 0 0 15px;">添加商品的二级分类和相应描述</p>
							<div class="buttonblock">
								<button type="submit" onclick="window.location.href=''">前往</button>
							</div>
						</div>
						<div class="homeblock2">
							<p style="margin: 15px;font-size: 20px;font-family: '微软雅黑';">编辑商品二级分类</p>
							<p style="border-top: 2px solid #999; width: 220px;margin:10px 0 8px 15px;height: 1px" />
							<p style="margin: 0 0 0 15px;">进行商品二级分类的查询，修改和删除</p>
							<div class="buttonblock">
								<button type="submit" onclick="window.location.href=''">前往</button>
							</div>
						</div>
					...
					<div class="homeblock2">
							...
							<p style="border-top: 2px solid #999; width: 220px;margin:10px 0 8px 15px;height: 1px" />
							<p style="margin: 0 0 0 15px;">用于查询二级分类下辖的所有商品</p>
							<div class="buttonblock">
								<button type="submit" onclick="window.location.href=''">前往</button>
							</div>
						</div>
