		...
		<div id="wrapper">
			...
			<div id="page-wrapper" style="background: #f2f2f2;min-width: 800px;  min-height: 299px;">
				<div class="page-navigation">
					<strong>分站库房调拨入库/ Goods transferred into subWarehouse</strong>
				</div>
				<!-- 搜索 -->
				<div style="display: flex;flex-direction: column;align-items:flex-start;">
					<div class="homeblock3" style="margin-left:auto; margin-right:auto;">
						<form action="warehouseManageServlet?action=selectWork" method="post" role="form">
								...
								<div style="float:left;margin: 11px 20px 0 40px; width:254px;">
									<input type="text" name="workIdInput" class="form-control1" style="height: 34px;border-radius: 4px; line-height:18px;" placeholder="">
								</div>
				...
				<!--/# 搜索 -->
					...
					<div class="searchResult">
						...
						<form action="warehouseManageServlet?action=editReceive" method="post">
						<div class="searchItem">
						    <p class="p70">${workId}</p>
							<p class="p90">${receivePerson}</p>
							<p class="p90" name="receiveDate">${receiveDate}</p>
				...
				<form action="warehouseManageServlet?action=receive" method="post" >
					<button type="submit" onclick="" class="buttonB" style=" margin:90px 0 0 580px; float:left">领货</button>
				</form>
				</div>
