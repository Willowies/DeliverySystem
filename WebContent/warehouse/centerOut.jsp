	...
	<body>
		<div id="wrapper">
						...
						<ul class="nav" id="side-menu">
							...
							<li class="active">
							    ...
							    <ul class="nav nav-second-level">
							    	<li class="highlight-item active">
			...
			<div id="page-wrapper" style="background: #f2f2f2;min-width: 800px;">
					<div class="page-navigation"><strong>中心库房调拨出库 / Transfer goods out of the central warehouse</strong></div>
					<div class="searchblock">
						<p1 style="margin: 15px;font-size: 18px;font-family: '微软雅黑';">搜索货物调拨单</p1>	
						<form action="warehouseManageServlet?action=selectTransfer" method="post" role="form">			
						    <p style="margin: 15px 0 5px 16px;font-size: 15px; width:254px;">要求完成日期</p>
						    <input name="completeDate" type="date" name="purchaseInId" class="form-control1" style="margin: 2px 0 5px 16px;height: 34px;border-radius: 4px; line-height:18px;" placeholder="">						
