	...
	<body>
		<div id="wrapper">
			...
			<div id="page-wrapper" style="background: #f2f2f2;min-width: 800px;">
					<div class="page-navigation"><strong>中心库房购货入库 / Central warehouse purchases goods</strong></div>
					<div class="searchblock" style="height:400px;">
						<p1 style="margin: 15px;font-size: 18px;font-family: '微软雅黑';">编辑入库信息</p1>	
						<form action="warehouseManageServlet?action=saveSubWarehouse" method="post" role="form">			
						    <p style="margin: 15px 0 5px 16px;font-size: 15px; width:254px;">入库日期</p>
						    <input name="inDateInput" type="date" class="form-control1" style="margin: 2px 0 5px 16px;height: 34px;border-radius: 4px; line-height:18px;" placeholder="">						
