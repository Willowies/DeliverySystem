	...
	<body>
		<div id="wrapper">
			...
			<div id="page-wrapper" style="background: #f2f2f2;display: flex;">
				<form action="./warehouseReturnManageServlet?action=searchSubReturnOrder" method="post">
					<div class="page-navigation">中心退货入库  / Center return </div>
				...
				<div class="resultblock" style="height: 350px;">
					...
					<form action="./warehouseReturnManageServlet?action=centerReturnIn" method="post" style="flex: 1;display: flex;flex-direction: column;">
					...
					<div class="result-foot" style="display: flex;">
						...
						<div class="operate-button" style="margin: 0 auto;">
							<button class="b" type="submit">确认入库</button>
						</div>
						<%}%>
					</div>
					</form>
