	...
	<body>
		<div id="wrapper">
			...
			<div id="page-wrapper" style="background: #f2f2f2;min-width: 800px;">
					<div class="page-navigation"><strong>查询分发信息 / Query distribution information</strong></div>
					<div class="searchblock" style="height:425px;">
						<p1 style="margin: 15px;font-size: 18px;font-family: '微软雅黑';">搜索分发信息</p1>	
						<form action="warehouseManageServlet?action=selectDistribution" method="post" role="form">			
						    ...
						    <input name="outDateInput" type="date" name="purchaseInId" class="form-control1" style="margin: 2px 0 5px 16px;height: 34px;border-radius: 4px; line-height:18px;" placeholder="">
						    <p style="margin: 15px 0 5px 16px;font-size: 15px; width:254px;">商品名称</p>
						    <input name="productInput" type="text" name="purchaseInId" class="form-control1" style="margin: 2px 0 5px 16px;height: 34px;border-radius: 4px; line-height:18px;" placeholder="全部">
						     <p style="margin: 15px 0 5px 16px;font-size: 15px; width:254px;">仓库名称</p>
						    <input name="warehouseName" type="text" name="purchaseInId" class="form-control1" style="margin: 2px 0 5px 16px;height: 34px;border-radius: 4px; line-height:18px;" placeholder="全部">						
