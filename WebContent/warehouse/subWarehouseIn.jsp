	...
	<body>
		<div id="wrapper">
			...
			<div id="page-wrapper" style="background: #f2f2f2;min-width: 800px;">
					<div class="page-navigation"><strong>分站库房调拨入库/ Goods transferred into subWarehouse</strong></div>
					<div class="searchblock">
						<p1 style="margin: 15px;font-size: 18px;font-family: '微软雅黑';">搜索入库单</p1>	
						<form action="warehouseManageServlet?action=selectDistri" method="post" role="form">			
						    <p style="margin: 15px 0 5px 16px;font-size: 15px; width:254px;">验货单号</p>
						    <input type="text" name="distributionInId" class="form-control1" style="margin: 2px 0 5px 16px;height: 34px;border-radius: 4px; line-height:18px;" placeholder="">						
