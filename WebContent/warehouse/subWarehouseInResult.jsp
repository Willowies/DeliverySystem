			...
			<div id="page-wrapper" style="background: #f2f2f2;min-width: 800px;  min-height: 299px;">
				...
				<div style="display: flex;flex-direction: column;align-items:flex-start;">
					<div class="homeblock3" style="margin-left:auto; margin-right:auto;">
						<form action="warehouseManageServlet?action=selectDitri" method="post" role="form">
							
								<p style="float:left; margin: 17px 20px 5px 80px;width= 20px;font-size: 15px;">验货单号</p>
								<div style="float:left;margin: 11px 20px 0 40px; width:254px;">
									<input type="text" name="distributionInId" class="form-control1" style="height: 34px;border-radius: 4px; line-height:18px;" placeholder="">
								</div>
				...
				<!--/# 搜索 -->
					...
					<div class="searchResult">
						...
						<form action="warehouseManageServlet?action=editSubWarehouse" method="post">
						<div class="searchItem">
						    <p class="p70">${distributionId}</p>
							<p class="p90">${productName}</p>
							<p class="p90">${expectedQuantity}</p>
							<p class="p90">${acturalQuantity}</p>
							<p class="p90" name="inDate">${inDate}</p>
				...
				<form action="warehouseManageServlet?action=subWarehouseIn" method="post" >
