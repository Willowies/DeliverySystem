	...
	<body>
		<div id="wrapper">
			...
			<div id="page-wrapper" style="background: #f2f2f2;min-width: 800px;">
					<div class="page-navigation"><strong>领货/ Picking</strong></div>
					<div class="searchblock" style="height:400px;">
						<p1 style="margin: 15px;font-size: 18px;font-family: '微软雅黑';">编辑领货信息</p1>	
						<form action="warehouseManageServlet?action=saveReceive" method="post" role="form">			
						    <p style="margin: 15px 0 5px 16px;font-size: 15px; width:254px;">领货日期</p>
						    <input name="receiveDateInput" type="date" class="form-control1" style="margin: 2px 0 5px 16px;height: 34px;border-radius: 4px; line-height:18px;" placeholder="">						
						    <p style="margin: 15px 0 5px 16px;font-size: 15px; width:254px;">领货人</p>
						    <input name="personInput" type="text" class="form-control1" style="margin: 2px 0 5px 16px;height: 34px;border-radius: 4px; line-height:18px;" placeholder="">
						    <p style="margin: 15px 0 5px 16px;font-size: 15px; width:254px;">备注</p>
						    <input name="remarkInput" type="text" class="form-control1" style="margin: 2px 0 5px 16px;height: 34px;border-radius: 4px; line-height:18px;" placeholder="">
